...
// Setters
	...
	inline void setCharacterSize(const int size);
...
TPL inline void CLS::setTextSize(const int size){
...
TPL inline int CLS::getCharacterSize() const{
...
TPL inline void CLS::setCharacterSize(const int size){
